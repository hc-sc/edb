(function () {
  'use strict';
    ...
    angular.module('ghstsApp')

    .directive('uiTreeNode', ['treeConfig', 'UiTreeHelper', '$window', '$document', '$timeout', '$q', '$rootElement', 'documentService', 
      function (treeConfig, UiTreeHelper, $window, $document, $timeout, $q, $rootElement, documentService) {
        return {
          ...
          link: function (scope, element, attrs, controllersArr) {
            ...
            scope.getNodeTitle = function () {

                var title = scope.$parent.node.NODE_NAME;
                if (scope.$parent.node.NODE_HEADING) {
                    title += " - " + scope.$parent.node.NODE_HEADING;
                }
                return title;
            }
            ...
            //    var toc2doc = scope.$parent.node.TOC2DOC;
            ...
            //                    isDocument : true
            //                }
            //                if (!scope.$modelValue.TOC_NODE) {
            //                    scope.$modelValue.TOC_NODE = [];
            //                }
            //                scope.$modelValue.TOC_NODE.push(docNode);
            //            }
            //        });
            //    }
            //}
