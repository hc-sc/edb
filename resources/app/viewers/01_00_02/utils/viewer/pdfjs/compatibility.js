...
e++%4)?g+=String.fromCharCode(255&c>>(-2*e&6)):0)
...
navigator.userAgent.indexOf("Trident")>=0&&(PDFJS.disableCreateObjectURL=!0)}(),
...
// Support: Safari 6.0+
var a=Object.prototype.toString.call(window.HTMLElement).indexOf("Constructor")>0,b=/Android\s[0-2][^\d]/,c=b.test(navigator.userAgent);(a||c)&&(PDFJS.disableRange=!0,PDFJS.disableStream=!0)}(),
...
// Support: Android 2.x
(!history.pushState||navigator.userAgent.indexOf("Android 2.")>=0)&&(PDFJS.disableHistory=!0)}(),
...
var a,b=!1;if(navigator.userAgent.indexOf("Chrom")>=0?(a=navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./),
// Chrome < 21 lacks the set function.
b=a&&parseInt(a[2])<21):navigator.userAgent.indexOf("Android")>=0?
// Android < 4.4 lacks the set function.
// Android >= 4.4 will contain Chrome in the user agent,
// thus pass the Chrome check above and not reach this block.
b=/Android\s[0-4][^\d]/g.test(navigator.userAgent):navigator.userAgent.indexOf("Safari")>=0&&(a=navigator.userAgent.match(/Version\/([0-9]+)\.([0-9]+)\.([0-9]+) Safari\//),
// Safari < 6 lacks the set function.
b=a&&parseInt(a[1])<6),b){var c=window.CanvasRenderingContext2D.prototype;c._createImageData=c.createImageData,c.createImageData=function(a,b){var c=this._createImageData(a,b);return c.data.set=function(a){for(var b=0,c=this.length;c>b;b++)this[b]=a[b]},c}}}}(),
